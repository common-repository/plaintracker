...
<?php
	...
	public function renderChange( array $x, _Audit $mAudit, _Record $m1, _Record $m2 )
	{
	...
	public function renderChangeId( array $x, _Audit $mAudit, _Record $m1, _Record $m2 )
	{
?>

<tr>
	<td colspan="3">__Time card created__</td>
</tr>

<?php
	}

	public function renderChangeState( array $x, _Audit $mAudit, _Record $m1, _Record $m2 )
	{
?>
...
<tr>
	...
	<td>
		<?php echo $this->presenter->htmlState( $x, $m2->stateId ); ?>
	</td>
	<td>
		<del>
			<?php echo $this->presenter->htmlState( $x, $m1->stateId ); ?>
		</del>
	</td>
</tr>
